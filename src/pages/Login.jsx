...
const FormContainer = styled.div`
  ...
  input {
    ...
    padding: 1rem;
    border: 0.1rem solid #075e54; /* WhatsApp primary color */
    border-radius: 0.4rem;
    color: #075e54; /* WhatsApp primary color */
    width: 100%;
    font-size: 1rem;
    &:focus {
      border: 0.1rem solid #25d366; /* WhatsApp secondary color */
      outline: none;
    }
  }
  button {
    ...
    text-transform: uppercase;
    &:hover {
      background-color: #128c7e; /* Slightly darker green for hover effect */
    }
  }
  span {
    color: #075e54; /* WhatsApp primary color */
